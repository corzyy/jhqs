...
SHELL_NS = ("^(bar|menu|calendar|settings|updatecenter|vitals|systemtray|"
            "networkpanel|weather|volumepanel|bluetoothpanel|"
...
def dump() -> None:
    ...
    for key, (path, default) in FIELDS.items():
        ...
        if isinstance(default, bool):
            ...
            value = str(value)
        out[key] = value
    # Shell layer override: last matching rule with an explicit blur_optimized.
    shell_opt = True
