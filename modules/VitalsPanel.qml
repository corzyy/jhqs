                ...
                Flickable {
                    ...
                    Column {
                        ...
                        MetricCard {
                            ...
                            subtitle: scope.fmtGb(VitalsService.ramUsedGb) + " / " + scope.fmtGb(VitalsService.ramTotalGb) + " used"
                        }
                        MetricCard {
                        ...
                        Column {
                            width: parent.width
                            spacing: 4
                            visible: VitalsService.topProcs.length > 0
                            Text {
                                text: "TOP PROCESSES"
                                font.family: Theme.fontFamily; font.pixelSize: Theme.fs(10)
                        ...
                        Text {
                            ...
                            text: "Configure in Settings → Modules → Vitals"
                            font.family: Theme.fontFamily; font.pixelSize: Theme.fs(10)
                            color: Theme.textMuted
